					...
					<div class="box-body">
						<div class="main-slideshow">
		                    <div class="flexslider">
		                        <ul class="slides">
		                        <?php foreach ($product_data as $s): ?>
		                        	<?php if($s->status == 1):?>
		                        		<?php if($s->qty <> 0){?>
		                            <li>
		                                <img src="<?php echo base_url('doc/images/produk')?>/<?php echo $s->images ?>" />
		                                <div class="slider-caption">
		                                    <h2><a href="<?php echo base_url(); ?>welcome/detail_produk/<?php echo $s->group_product;?>/<?php echo $s->produk;?>"><?php echo $s->produk ?></a></h2>
		                                    <p><?php echo character_limiter($s->deskripsi_produk,10);?></p>
		                                    <p class="alert alert-info">
												Stock : <?php echo $s->qty;?><br>
												Harga : Rp. <?php echo $this->cart->format_number($s->harga);
												?><br>
												Brand : <?php echo $s->brand;?>
											</p>
											<a class="btn btn-primary btn-xs" href="<?php echo base_url(); ?>welcome/detail_produk/<?php echo $s->group_product;?>/<?php echo $s->produk;?>">Read more</a>
		                                </div>
		                            </li>
		                            	<?php }else{?>
		                            	<li> 
			                            	<div class="error-page">
			                            	 <h2 class="headline text-yellow"> 404</h2>
				                            	...
				                            	<p class="alert alert-warning text-center"> Slide Product Not Active!!</p>
				                            	</div>
			                            	</div>
		                            	</li>
		                            	<?php }?>
			...
			<div class="row">
					<div class="col-md-8" id="layanan">
							<div class="box-body">
								...
								<form action="<?php echo site_url('welcome/product#layanan'); ?>" class="form-inline" method="get">
			                    <div class="input-group">
			                        ...
			                        <span class="input-group-btn">
			                            <?php 
			                                ...
			                                {
			                                    ?>
			                                    <a href="<?php echo site_url('welcome/product#layanan'); ?>" class="btn btn-default">Reset</a>
			                                    <?php
			                                }
			                            ?>
