				...
				<div class="col-md-8">
					...
					<div class="row">
				            <div class="col-md-12">
				                ...
				                <h6><span class="page-active">Halaman</span></h6>
				            </div>
				        </div>
					<div class="col-md-3 pull-right">
							<form action="<?php echo site_url('welcome/gethalaman'); ?>" class="form-inline" method="get">
		                    <div class="input-group">
		                        ...
		                        <span class="input-group-btn">
		                            <?php 
		                                ...
		                                {
		                                    ?>
		                                    <a href="<?php echo site_url('welcome/gethalaman'); ?>" class="btn btn-default">Reset</a>
		                                    <?php
		                                }
		                            ?>
						...
						<br>
							...
							<?php foreach($pages_data as $page):?>
								<div class="row">
							            <div class="col-md-12">
							            	<ul class="timeline">
							                <li class="timeline-header"><h6><a href="<?php echo base_url('welcome/getpages/'.$page->id.'/'.$page->slug.'');?>"><i class="fa fa-link bg-blue"></i><?php echo $page->title;?></a></h6></li>
							                </ul>
							            </div>
					             </div>
							<?php endforeach;?>
					    ...
					    <a href="#" class="btn btn-primary">Total Halaman: <?php echo $jml_rows ?></a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="box-body">
