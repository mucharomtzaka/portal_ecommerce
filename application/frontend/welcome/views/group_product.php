				        ...
				        <div class="row">
				            <div class="col-md-12">
				                ...
				                <h6><a href="<?php echo base_url('welcome/product'); ?>">Product</a></h6>
				                 <h6><span class="page-active"><?=$kode_group ?></span></h6>
				            </div>
				        </div>
				     </div>
					<div class="box-body">
						<form action="<?php echo site_url('welcome/group_product/'.$id_group_product.''); ?>" class="form-inline" method="get">
		                    <div class="input-group">
		                        ...
		                        <span class="input-group-btn">
		                            <?php 
		                                ...
		                                {
		                                    ?>
		                                    <a href="<?php echo site_url('welcome/group_product/'.$id_group_product.''); ?>" class="btn btn-default">Reset</a>
		                                    <?php
		                                }
		                            ?>
		                     ...
		                     <a href="#" class="btn btn-primary pull-right">Total Record : <?php echo count($group_product_data);?></a>
		                </form>

						<div class="row">
							<div id="Grid">
								<?php if(count($group_product_data) =='0'){?>
               				 ...
               				 <?php }else{?>
               				 	<?php foreach($group_product_data as $t):?>
               				 		<?php if($t->status =='1'){?>
									...
									<img src="<?php echo base_url('doc/images/produk')?>/<?php echo $t->images ?>" alt="<?php echo $t->produk ?>" class="margin" width="150px" height="100px">
											...
											<p class="alert alert-info">
												...
												Harga : Rp. <?php echo $this->cart->format_number($t->harga);?><br>
