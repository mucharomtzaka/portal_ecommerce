    ...
    <div class="row text-center">
            ...
            <?php if($runningtext !=''){?>
   			<div class="callout callout-info">
                <p><marquee direction="right" scrollamount="1" scrolldelay="10"><blink><?php echo $runningtext;?></blink></marquee></p>
             </div> 
           <?php } ?>
 </div>
 </section>
		...
		<div class="row">
						...
						<div class="main-slideshow">
		                    <div class="flexslider">
		                        	...
		                        	<li>
			                            	...
			                            	<div class="error-page">
			                            	 <h2 class="headline text-yellow"> 404</h2>
				                            	...
				                            	<p class="alert alert-warning text-center"> Slide  Not Active!!</p>
				                            	</div>
			                            	</div>
		                        ...
		                        <?php foreach ($slider as $s): ?>
		                        	<?php if($s['status'] == 1):?>
		                            <li>
		                                <img src="<?php echo base_url(); ?>doc/images/blog/<?=$s['img_header']?>" />
		                                <div class="slider-caption">
		                                    <h2><a href="<?php echo base_url(); ?>welcome/viewpage/<?=$s['category']?>/<?=$s['slug']?>"><?=$s['title']?></a></h2>
				...
				<div class="col-md-4">
					...
					<fieldset>
						...
						<marquee direction="up" scrollamount="1" scrolldelay="10">
					...
					<fieldset>
						<legend><h4 class="widget-title"><i class="fa fa-calendar"></i> Kalender</h4></legend>
  	...
  	<div class="box box-succes">
  		<div class="row">
  			<div class="col-md-8">
  				<div class="box-body">
  				<fieldset>
							<legend><h4 class="widget-title"><i class="fa fa-th"></i>Produk Lainnya</h4></legend>
									 ...
									 <a  class="fancybox" rel="gallery1" href="<?php echo base_url('doc/images/produk')?>/<?php echo $t->images ?>">
										...
										<img src="<?php echo base_url('doc/images/produk')?>/<?php echo $t->images ?>" alt="<?php echo $t->produk ?>">
											...
											<div class="blog-list-details ">
												...
												<?php echo character_limiter($t->deskripsi_produk,100);?>
												<?php if($t->qty <> 0){?>
											...
											<?php } ?>
																...
																<div class="gallery-content">
																	<a class="btn btn-default btn-xs" href="<?php echo base_url(); ?>welcome/detail_produk/<?php echo $t->group_product;?>/<?php echo $t->produk;?>">Read more</a>
																</div>	
															</div>
														</div>
												 <?php } ?>
		...
		<div class="row">
				...
				<div class="col-md-4">
						<div class="box-body">
							...
							<?php endforeach;?>
							<a class="btn btn-primary btn-xs" href="<?php echo base_url(); ?>welcome/iklan">Read more</a>
							<?php echo $ads;?>
							</fieldset>
							<fieldset>
							...
							<fieldset>
								<legend><h4 class="widget-title"><i class="fa fa-sitemap"></i>Halaman</h4></legend>
								<?php foreach($halaman as $page):?>
										<div class="row">
									            <div class="col-md-12">
									            <h6><a href="<?php echo base_url('welcome/getpages/'.$page->id.'/'.$page->slug.'');?>"><i class="fa fa-link bg-blue"></i><?php echo $page->title;?></a></h6>
									            </div>
							             </div>
									<?php endforeach;?>
									<a class="btn btn-primary btn-xs" href="<?php echo base_url(); ?>welcome/gethalaman">Read more</a>
							</fieldset>
						</div>
					</div>
				<div class="col-md-4">
		...
		<div class="row">
			...
			<div class="col-md-4">
					<div class="box-body">
						...
						<div id="kurir">
						<fieldset>
							<legend><h4 class="widget-title"><i class="fa fa-truck"></i>Expedisi Pengiriman </h4></legend>
							<div class="widget-inner">
							<div class="gallery-small-thumbs clearfix">
							<?php foreach ($kurir as $key => $value):?>
								 <div class="thumb-small-gallery">
								<img src="<?php echo base_url();?>doc/images/kurir/<?php echo $value['img_shipping'];?>" alt="<?php echo $value['name_shipping'];?>">
								</div>
							<?php endforeach;?>
							</div>
							</div>
