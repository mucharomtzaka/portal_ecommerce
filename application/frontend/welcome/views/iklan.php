 				...
 				<div class="col-md-2">
 					...
 					<div class="col-md-8">
 						<a href="#" class="btn btn-primary pull-right">Total Record : <?php echo $total_rows ?></a>
 							<div class="col-md-5">
				                <form action="<?php echo site_url('welcome/iklan'); ?>" class="form-inline" method="get">
				                    <div class="input-group">
				                        ...
				                        <span class="input-group-btn">
				                            <?php 
				                                ...
				                                {
				                                    ?>
				                                    <a href="<?php echo site_url('welcome/iklan'); ?>" class="btn btn-default">Reset</a>
				                                    <?php
				                                }
				                            ?>
				            ...
				            <?php }else{?>
				            		<div class="page-title clearfix">
									  <div class="row">
		               				 	<div id="Grid">
					            	<?php foreach($iklan_data as $g):?>
					            		<?php if($g->status ==1):?>
											<div class="col-md-4 mix students" data-cat="3">
												<div class="gallery-item">
												 <a href="<?php echo base_url(); ?>welcome/viewpromo/<?php echo $g->group_product;?>/<?php echo $g->slug;?>"><h3 class="timeline-header"><?php echo $g->title_promo ?></h3>
																</a>
													<?php if($g->banner !=''){?>
													<a  class="fancybox" rel="gallery1" href="<?php echo base_url('doc/images/iklan')?>/<?php echo $g->banner?>">
													<div class="gallery-thumb">
													<img src="<?php echo base_url('doc/images/iklan')?>/<?php echo $g->banner ?>" alt="<?php echo $t->produk ?>" class="margin" width="150px" height="100px">
													</div>
													</a>
													<?php } ?>
													<div class="blog-list-details">
													<span class="bg-red"><?php echo $g->date ?></span>
													<?php echo character_limiter($g->content,100);?>
													</div>
													<div class="gallery-content">
													 <a  class="btn btn-info" href="<?php echo base_url(); ?>welcome/viewpromo/<?php echo $g->group_product;?>/<?php echo $g->slug;?>"><h6 class="timeline-header">Read More</h6>
																</a>
												</div>
												</div>
											</div>
