				 ...
				 <div class="page-title clearfix">
			        <div class="row">
			            <div class="col-md-12">
			                ...
			                <h6><span class="page-active">Album</span></h6>
			            </div>
			            <div class="col-md-5 pull-right">
			            	<fieldset>
			            		<legend >Filter</legend>
						          <form action="<?php echo site_url('welcome/galeries'); ?>" class="form-inline" method="get">
			                    <div class="input-group">
			                        ...
			                        <span class="input-group-btn">
			                            <?php 
			                                ...
			                                {
			                                    ?>
			                                    <a href="<?php echo site_url('welcome/galeries'); ?>" class="btn btn-default">Reset</a>
			                                    <?php
			                                }
			                            ?>
					...
					<div class="page-title clearfix">
						...
						<div class="row">
               				 <div id="Grid">
               				 <?php if(count($album_data)<>''){?>
							<?php foreach($album_data as $g):?>
								<div class="col-md-4 mix students" data-cat="3">
			                        <div class="gallery-item">
			                            <a href="<?=base_url();?>welcome/album_galeri/<?=$g->id;?>">
			                                <div class="gallery-thumb">
			                                    <img src="<?=site_url(); ?>doc/images/album/<?php echo $g->sampul_album ;?>" alt=" <?php echo $g->nama_album;?>" />
			                                </div>
