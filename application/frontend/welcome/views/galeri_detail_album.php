				 ...
				 <div class="page-title clearfix">
			        <div class="row">
			            <div class="col-md-12">
			                ...
			                <h6><span>Detail Gallery</span></h6>
			                <h6><span class="page-active"><?php echo $title_img;?></span></h6>
			            </div>
			        </div>
			    </div>
					<div class="page-title clearfix">
						<div class="box-body">
							...
							<div class="col-md-4 mix students" data-cat="3">
				                        <div class="gallery-item">
				                         <a  class="fancybox" rel="gallery1" href="<?=site_url(); ?>doc/images/galeri/<?php echo $image_url ;?>">
				                                <div class="gallery-thumb">
				                                    <img src="<?=site_url(); ?>doc/images/galeri/<?php echo $image_url ;?>" alt=" <?php echo $title_img;?>" />
				                                </div>
				                                <div class="gallery-content">
				                                    <h4 class="gallery-title"><?php echo $title_img;?></h4>
				                                </div>
				                               </a>
				                        </div> <!-- /.gallery-item -->
				                    </div> <!-- /.col-md-4 -->
				               ...
				               <?php echo $keterangan;?>
				               <br>
				                 <a href="javascript:history.go(-1);" class="btn btn-warning"><i class="fa fa-arrow-left">back </i></a>
				               </div>
				            </div>
						</div>
					</div>
