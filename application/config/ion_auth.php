 ...
 */
$config['site_title']                 = "Trefast Administrators";       // Site Title, example.com
...
$config['user_expire']                = 86500;               // How long to remember the user (seconds) 86500. Set to zero for no expiration
