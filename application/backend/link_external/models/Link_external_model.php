...
class Link_external_model extends CI_Model{

public $table = 'link_external';
public $id = 'id';
public $order = 'DESC';
...
/* End of file Link_external_model.php */
/* Location: C:\xampp\htdocs\trefastcms\application\backend/link_external/models/Link_external_model.php */
