...
// get data by id
 ...
 // get total rows
    function total_rows($q = NULL) {
                $this->db->like('id', $q);
	$this->db->or_like('name_addons', $q);
	$this->db->or_like('technical_support', $q);
	$this->db->or_like('status_addons', $q);
...
/* Location: C:\xampp\htdocs\trefastcms\application\backend/addons/models/Addons_model.php */
