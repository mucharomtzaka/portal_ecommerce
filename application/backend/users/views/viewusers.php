                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('users/index'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
         <?php echo anchor('users/create_users', lang('index_create_user_link'),'class="btn btn-primary"')?>
       | <?php echo anchor('users/create_group', lang('index_create_group_link'),'class="btn btn-primary"')?>
       ...
       <p color="red"> <?php echo $message;?></p>
        ...
        <div class="table-responsive">
         ...
         <thead>
            <tr>
          <th>#</th>
            <th><?php echo lang('index_usersname');?></th>
         ...
         <tbody>
           <?php foreach ($users as $users):?>
            <tr>
                    <td>#</td>
                    <td><?php echo htmlspecialchars($users->usersname,ENT_QUOTES,'UTF-8');?></td>
              ...
              <td><i class="fa fa-edit"></i><?php echo anchor("users/edit_users/".$users->id, 'Edit','class=" btn btn-info" ') ;?></td>
               <?php if($group->id !='1'&&$group->id !='3'){?>
                         <td><?php echo anchor("users/delete_users/".$users->id, 'delete','class="btn btn-warning"') ;?></td>
              <?php }?>
            </tr>
          <?php endforeach;?>
         </tbody>
