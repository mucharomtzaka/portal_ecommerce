...
// get data by id
 ...
 // get total rows
    function total_rows($q = NULL) {
                $this->db->like('id', $q);
	$this->db->or_like('group_product_name', $q);
...
/* End of file Group_product_model.php */
/* Location: C:\xampp\htdocs\trefastcms\application\backend/group_product/models/Group_product_model.php */
