...
// get data by id
 ...
 // get total rows
    function total_rows($q = NULL) {
                $this->db->like('id', $q);
	$this->db->or_like('menu_frontend_title', $q);
	$this->db->or_like('menu_url_title', $q);
	$this->db->or_like('menu_frontend_status', $q);
	$this->db->or_like('menu_frontend_icon', $q);
	$this->db->or_like('menu_frontend_description', $q);
...
/* Location: C:\xampp\htdocs\trefastcms\application\backend/menu_frontend/models/Menu_frontend_model.php */
