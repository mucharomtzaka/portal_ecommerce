...
class Promo_iklan_model extends CI_Model{

public $table = 'promo_iklan';
public $id = 'id';
public $order = 'DESC';
...
/* End of file Promo_iklan_model.php */
/* Location: C:\xampp\htdocs\trefastcms\application\backend/promo_iklan/models/Promo_iklan_model.php */
