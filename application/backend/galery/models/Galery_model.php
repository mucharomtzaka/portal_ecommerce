...
// get data by id
 ...
 // get total rows
    function total_rows($q = NULL) {
                $this->db->like('id', $q);
	$this->db->or_like('id_album', $q);
	$this->db->or_like('title_img', $q);
	$this->db->or_like('image_url', $q);
...
/* Location: C:\xampp\htdocs\trefastcms\application\backend/galery/models/Galery_model.php */
