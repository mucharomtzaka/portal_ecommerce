 ...
 public function index()
    {
        ...
        $this->template->render_backend('groups_list', array_merge($this->data ));
    }
    ...
    public function read($id) 
    {
		...
		'description' => $row->description,
            ...
            $this->template->render_backend('groups_read',array_merge($this->data ));
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->render_backend('groups_form',array_merge($this->data ));
    }
...
/* Location: ./application/C:\xampp\htdocs\trefastcms\application\backend/groups/controllers/Groups.php */
