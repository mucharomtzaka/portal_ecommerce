...
class Routerapp_model extends CI_Model{

public $table = 'routerapp';
public $id = 'id';
public $order = 'DESC';
...
/* End of file Routerapp_model.php */
/* Location: C:\xampp\htdocs\trefastcms\application\backend/routerapp/models/Routerapp_model.php */
