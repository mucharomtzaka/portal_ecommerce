...
$string = "<div class=\"content-wrapper\">
 ...
 <div class=\"box-header with-border\">
        ...
        <div class=\"row\" style=\"margin-bottom: 10px\">
            <div class=\"col-md-4\">
                <?php echo anchor(site_url('".$c_url."/create'),'Create', 'class=\"btn btn-primary\"><i class=\"fa fa-plus\"></i'); ?>
            </div>
...
$string .= "\n\t\t\t<td style=\"text-align:center\">"
        . "\n\t\t\t\t<?php "
        . "\n\t\t\t\techo anchor(site_url('".$c_url."/read/'.$".$c_url."->".$pk."),'Read',' class=\"btn btn-default\"><i class=\"fa fa-eye\"></i'); "
        . "\n\t\t\t\techo ' | '; "
        . "\n\t\t\t\techo anchor(site_url('".$c_url."/update/'.$".$c_url."->".$pk."),'Update','class=\"btn btn-warning\"><i class=\"fa fa-edit\"></i'); "
        . "\n\t\t\t\techo ' | '; "
        . "\n\t\t\t\techo anchor(site_url('".$c_url."/delete/'.$".$c_url."->".$pk."),'Delete','onclick=\"javasciprt: return confirm(\\'Are You Sure  to Delete ?\\')\" class=\"btn btn-danger\"><i class=\"fa fa-trash\"></i'); "
        . "\n\t\t\t\t?>"
        . "\n\t\t\t</td>";
...
$hasil_view_list = createFile($string, $path_view.'/'. $v_list_file);
