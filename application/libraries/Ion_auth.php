...
class Ion_auth
{
	...
	public function is_member_premium($id=false)
	{
		$this->ion_auth_model->trigger_events('is_member_premium');

		$programmer_group = $this->config->item('premium_group', 'ion_auth');
